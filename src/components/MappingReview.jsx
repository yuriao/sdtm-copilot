...
const COMMON_SDTM_VARS = [
  ...
  'AESEQ', 'AETERM', 'AESTDTC', 'AESER', 'AESEV', 'AEREL', 'AEOUT', 'AEDTC', 'AETOXGR', 'AEDECOD', 'AEBODSYS',
  'LBSEQ', 'LBTESTCD', 'LBTEST', 'LBORRES', 'LBDTC', 'LBORRESU', 'LBSTRESC', 'LBSTRESN', 'LBSTRESU', 'LBSTAT', 'LBNRIND',
  'VSSEQ', 'VSTESTCD', 'VSTEST', 'VSORRES', 'VSORRESU', 'VSSTRESC', 'VSSTRESN', 'VSSTRESU', 'VSSTAT', 'VSDTC',
  'CMSEQ', 'CMTRT', 'CMDECOD', 'CMCAT', 'CMSTDTC', 'CMENDTC', 'CMDOSE', 'CMDOSU', 'CMDOSFRQ', 'CMROUTE',
  'ECSEQ', 'ECTRT', 'ECDOSE', 'ECDOSU', 'ECDOSFRQ', 'ECROUTE', 'ECSTDTC', 'ECENDTC', 'ECSTAT',
